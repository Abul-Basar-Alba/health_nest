...
class FirebaseAdminService {
  ...
  static Future<Map<String, dynamic>> getFirebaseConsoleData() async {
    try {
      final rulesSnapshot =
          await _firestore.collection('_admin').doc('firestore_rules').get();
  ...
  static Future<Map<String, dynamic>> deployToFirebaseConsole(
      String rules) async {
    ...
    try {
      ...
      if (deployResult['success'] == true) {
        ...
        return {
          'success': true,
          'message':
              'Rules prepared for deployment. Please check Firebase Console.',
          'consoleUrl': getFirebaseConsoleUrls()['rules'],
          'instructions':
              'Copy rules to Firebase Console manually or use Firebase CLI',
        };
      }
    } catch (e) {
      return {
  ...
  static Map<String, String> getFirebaseConsoleUrls() {
    return {
      ...
      'rules':
          'https://console.firebase.google.com/project/$_projectId/firestore/rules',
      'database':
          'https://console.firebase.google.com/project/$_projectId/firestore/data',
      'auth':
          'https://console.firebase.google.com/project/$_projectId/authentication/users',
      'functions':
          'https://console.firebase.google.com/project/$_projectId/functions/list',
      'analytics':
          'https://console.firebase.google.com/project/$_projectId/analytics/app/android:com.example.health_nest',
      'hosting':
          'https://console.firebase.google.com/project/$_projectId/hosting/main',
    };
  }
  ...
  static Stream<Map<String, dynamic>> vscodeRulesStream() {
    return _firestore
      ...
      return {
        'lastUpdated':
            data['updatedAt']?.toDate()?.toIso8601String() ?? 'Never',
