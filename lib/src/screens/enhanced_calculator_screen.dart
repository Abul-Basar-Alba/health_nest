...
class EnhancedCalculatorScreen extends StatefulWidget {
  ...
  @override
  State<EnhancedCalculatorScreen> createState() => _EnhancedCalculatorScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          if (!_isLoading && _usageStatus != null && !_usageStatus!['isPremium'])
            Container(
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 12,
                                        color: calculator.color.withOpacity(0.7),
                                      ),
                                    ),
                                  ],
                                ),
                              ...
                              // Disabled overlay
                              if (!canUse && !(_usageStatus?['isPremium'] ?? false))
                                Positioned.fill(
                                  child: Container(
                                    decoration: BoxDecoration(
                  ...
                  Container(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: const Text('Upgrade to Premium - Unlimited Calculators'),
